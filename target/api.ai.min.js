...
(a=!0);return a};e.prototype.reset=function(){this.minCZ=5;this.maxCZ=15;this.frameLengthMilis=10;this.maxSilenceLengthMilis=3.5;this.minSilenceLengthMilis=.8;this.silenceLengthMilis=this.maxSilenceLengthMilis;this.sequenceLengthMilis=.03;this.minSequenceCount=3;this.energyFactor=3.1;this.noiseFrames=Math.round(150/this.frameLengthMilis);this.frameNumber=this.noiseEnergy=0;this.lastActiveTime=-1;this.time=this.sequenceCounter=this.lastSequenceTime=0};window.VAD=e})();(function(){function e(a,b,c,e){if(!a||!b)throw"Illegal TTS arguments: server and access_token are required.";this.access_token=b;this.server=a;this.lang=e;this.audio_context=c?c:new (window.AudioContext||window.webkitAudioContext)}e.prototype.tts=function(a,b,c){function e(a,b){var c=d.audio_context;c.decodeAudioData(a,function(a){console.log("play speech...");var d=c.createBufferSource();d.buffer=a;d.connect(c.destination);d.onended=b;d.start(0)},function(a){console.log("TTS decodeAudioData error is",
a)})}if(a){var d=this;a=encodeURIComponent(encodeURIComponent(a));var g=new ("onload"in new XMLHttpRequest?XMLHttpRequest:XDomainRequest);c=c||d.lang||"en-US";g.open("GET","https://"+d.server+"/api/tts?access_token="+d.access_token+"&lang="+c+"&text="+a,!0);g.responseType="arraybuffer";g.onload=function(a){e(this.response,b)};g.onerror=function(a){console.log("HttpRequest: Status:",this.status,"Reason:",a)};g.send()}};window.TTS=e})();(function(){function e(a){function b(){}a=a||{};this.server=a.server||"";this.token=a.token||"";this.sessionId=a.sessionId||e.generateRandomId();this.lang=a.lang||"en";this.contentType=a.contentType||"content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)16000,+format=(string)S16LE,+channels=(int)1";this.readingInterval=a.readingInterval||250;this.serverVersion="undefined"===typeof a.serverVersion?"20150910":a.serverVersion;this.onOpen=a.onOpen&&a.onOpen.bind(this)||b;this.onClose=a.onClose&&
a.onClose.bind(this)||b;this.onInit=a.onInit&&a.onInit.bind(this)||b;this.onStartListening=a.onStartListening&&a.onStartListening.bind(this)||b;this.onStopListening=a.onStopListening&&a.onStopListening.bind(this)||b;this.onResults=a.onResults&&a.onResults.bind(this)||b;this.onEvent=a.onEvent&&a.onEvent.bind(this)||b;this.onError=a.onError&&a.onError.bind(this)||b}e.generateRandomId=function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return a()+a()+"-"+a()+
"-"+a()+"-"+a()+"-"+a()+a()+a()};e.prototype.init=function(){function a(a,c){b.mediaStreamSource=b.audio_context.createMediaStreamSource(c);b.onEvent(2,"Media stream created");window.userSpeechAnalyser=b.audio_context.createAnalyser();b.mediaStreamSource.connect(window.userSpeechAnalyser);b.recorder=new Recorder(b.mediaStreamSource);b.onEvent(3,"Recorder initialized");a&&a()}var b=this;b.onEvent(1,"Waiting for approval to access your microphone ...");try{window.AudioContext=window.AudioContext||window.webkitAudioContext,
navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia,window.URL=window.URL||window.webkitURL,b.audio_context=new AudioContext}catch(c){b.onError(5,"Error initializing Web Audio browser: "+JSON.stringify(c))}if(navigator.getUserMedia)navigator.getUserMedia({audio:!0},a.bind(null,b.onInit),function(a){b.onError(5,"No live audio input in this browser: "+JSON.stringify(a))});else b.onError(5,"No user media support")};e.prototype.isInitialise=function(){return!!this.recorder};
e.prototype.sendJson=function(a){a.sessionId||(this.sessionId||(this.sessionId=this.generateRandomId()),a.sessionId=this.sessionId);this._socketSend(JSON.stringify(a));this._socketSend("EOS")};e.prototype.startListening=function(){function a(a){b.resample_processor=b.audio_context.createResampleProcessor(256,1,1,16E3);b.mediaStreamSource.connect(b.resample_processor);var c=b.audio_context.createEndOfSpeechProcessor(256);c.endOfSpeechCallback=a;b.resample_processor.connect(c)}var b=this,c=b.recorder;
if(c)if(b.ws)a(function(){b.stopListening()}),b.ws.send("{'timezone':'America/New_York', 'lang':'"+b.lang+"', 'sessionId':'"+b.sessionId+"'}"),b.intervalKey=setInterval(function(){c.export16kMono(function(a){b._socketSend(a);c.clear()},"audio/x-raw")},b.readingInterval),c.record(),b.onStartListening();else b.onError(3,"No web socket connection");else b.onError(3,"Recorder undefined")};e.prototype.stopListening=function(){var a=this;a.resample_processor&&a.resample_processor.disconnect();clearInterval(a.intervalKey);
var b=a.recorder;if(b)b.stop(),a.onEvent(11,"Stopped recording"),b.export16kMono(function(c){a._socketSend(c);a._socketSend("EOS");b.clear()},"audio/x-raw"),a.onStopListening();else a.onError(3,"Recorder undefined")};e.prototype.isOpen=function(){return!!this.ws};e.prototype.open=function(){function a(){function a(){var c="",c=b.serverVersion?b.server+"?v="+b.serverVersion+"&"+b.contentType+"&access_token="+b.token+"&sessionId="+b.sessionId:b.server+"?"+b.contentType+"&access_token="+b.token+"&sessionId="+
b.sessionId,c=new WebSocket(c);c.onmessage=function(a){a=a.data;b.onEvent(8,a);if(a instanceof Object&&!(a instanceof Blob))b.onError(4,"WebSocket: onEvent: got Object that is not a Blob");else if(a instanceof Blob)b.onError(4,"WebSocket: got Blob");else b.onResults(JSON.parse(a))};c.onopen=function(a){b.onOpen();b.onEvent(9,a)};c.onclose=function(a){b.onClose();b.onEvent(10,a.code+"/"+a.reason+"/"+a.wasClean)};c.onerror=function(a){b.onError(2,JSON.stringify(a.data))};return c}if(b.recorder){b.ws&&
b.close();try{b.ws=a()}catch(e){b.onError(5,"No web socket support in this browser!")}}else b.onError(3,"Recorder undefined")}var b=this;this.recorder?a():this.init(a)};e.prototype.close=function(){clearInterval(this.intervalKey);this.recorder&&(this.recorder.stop(),this.recorder.clear(),this.onEvent(11,"Stopped recording"));this.ws&&(this.ws.close(),this.ws=null)};e.prototype._socketSend=function(a){if(this.ws){var b=this.ws.readyState;if(1!=b){var c="WebSocket: ";switch(b){case 0:c+="The connection is not yet open.";
break;case 2:c+="The connection is in the process of closing.";break;case 3:c+="The connection is closed or couldn't be opened."}this.onError(2,c+(" readyState="+b+" (!=1) failed to send: "+a))}if(a instanceof Blob)if(0<a.size)this.ws.send(a),this.onEvent(5,"Send: blob: "+a.type+", "+a.size);else this.onEvent(6,"Send: blob: "+a.type+", EMPTY");else this.ws.send(a),this.onEvent(7,"Send string: "+a)}else this.onError(5,"No web socket connection: failed to send: "+a)};window.ApiAi=e})();
